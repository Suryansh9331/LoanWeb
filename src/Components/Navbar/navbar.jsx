...
const HeroWithNavbar = ({ onTriggerPopup }) => {
  const [isScrolled, setIsScrolled] = useState(false);
          ...
          >
            ...
            >
              ...
              onClick={onTriggerPopup}
                className={`relative overflow-hidden cursor-pointer bg-purple-600/10 text-purple-600 border-2 border-purple-600/20 rounded-full font-semibold transition-all duration-300 hover:bg-purple-600/15 hover:border-purple-600/30 hover:-translate-y-1 hover:shadow-lg hover:shadow-purple-500/20 group ${
                  isScrolled ? 'px-4 py-2 text-sm' : 'px-6 py-3 text-sm'
                } hidden sm:block`}
              >
                <span className="relative z-10">Learn More</span>
              ...
              <button
              onClick={onTriggerPopup}
                className={`relative cursor-pointer overflow-hidden bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-full font-semibold transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-purple-500/40 group ${
                  isScrolled ? 'px-4 py-2 text-sm' : 'px-6 py-3 text-sm'
                }`}
              >
                <span className="relative z-10">Get Started</span>
      ...
      <div className="relative min-h-auto bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden pt-24 pb-18">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between min-h-screen mt-10 px-8 lg:px-16 xl:px-24">
          ...
          <div className="flex-1 max-w-2xl">
            ...
            <h1 
              className={`text-5xl cursor-pointer lg:text-6xl font-bold text-white mb-6 leading-tight transform transition-all duration-700 ${
                isLoaded 
                  ? 'translate-y-0 opacity-100' 
                  : 'translate-y-10 opacity-0'
              }`}
