...
export default function Footer({ onTriggerPopup }) {
  ...
  const handleCallNow = () => {
    window.open('tel:+1 844-403-0233', '_self'); // Replace with real number
  };
      ...
      >
        ...
        <div className="mt-8 sm:mt-8">
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-8">
            ...
            <Link 
              to="/privacy-policy" 
              className="text-gray-300 hover:text-purple-400 transition-colors duration-300 text-sm sm:text-base"
            >
              Privacy Policy
            </Link>
            <Link 
        ...
        <div className="mt-4 sm:mt-6 text-center">
          <p className="text-gray-400 text-xs sm:text-sm">
            © 2025 Easewithdraw. All rights reserved. Trustpilot™ is a registered trademark.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-8 sm:mt-12">
        ...
        <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:justify-between sm:items-center pt-6 border-t border-gray-700">
          ...
          <div className="text-gray-400 text-sm text-center sm:text-right order-1 sm:order-2">
            ...
            <span className="hidden sm:inline-block mx-2">|</span>
            <a href="tel:+1 844-403-0233" className="text-purple-400 hover:text-purple-300 transition-colors duration-300">
              +1 844-403-0233
            </a>
          </div>
        </div>
