...
export default function HowItWorks() {
  return (
    <div className="w-full bg-[#f6eeff] py-30  lg:pb-38  overflow-hidden">
      {/* How It Works Label */}
      ...
      <div className="relative max-w-6xl   mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 md:gap-6">
          ...
          <div className="flex flex-col items-center text-center w-full max-w-xs">
            ...
            <p className="text-gray-500 text-md font-normal">Connect your crypto wallet</p>
            {/* Mobile-only dot */}
          ...
          <div className="flex flex-col items-center text-center w-full max-w-xs">
            ...
            <p className="text-gray-500 text-md font-normal">
              Choose your loan or credit amount{" "}
            </p>
            {/* Mobile-only dot */}
            <div className="md:hidden mt-4 bg-purple-600 h-3 w-3 rounded-full"></div>
          </div>
          ...
          <div className="flex flex-col items-center text-center w-full max-w-xs">
            ...
            <p className="text-gray-500 text-md font-normal">
              Get instant approval and start using your card
            </p>
            {/* Mobile-only dot */}
            <div className="md:hidden mt-4 bg-purple-600 h-3 w-3 rounded-full"></div>
          </div>
